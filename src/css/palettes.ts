...
export const light = {
  ...
  background: {
    ...
    secondaryAccent: originalPalette.black,
    secondaryAccentLight: originalPalette.gray6,
...
export const dark = {
  ...
  background: {
    ...
    secondaryAccent: originalPalette.gray1,
    secondaryAccentLight: originalPalette.gray2,
