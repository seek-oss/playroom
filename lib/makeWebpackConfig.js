...
const includePaths = [
  ...
  path.resolve(playroomPath, 'src-dist'),
...
module.exports = async (playroomConfig, options) => {
  ...
  const ourConfig = {
    ...
    entry: {
      index: [require.resolve('../src-dist/index.mjs')],
      frame: [require.resolve('../src-dist/frame.mjs')],
      preview: [require.resolve('../src-dist/preview.mjs')],
    },
    output: {
