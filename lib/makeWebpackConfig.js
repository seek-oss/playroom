  ...
  const ourConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        __PLAYROOM_ALIAS__PREVIEW_COMPONENT__: playroomConfig.previewComponent
          ? relativeResolve(playroomConfig.previewComponent)
          : require.resolve('./defaultModules/PreviewComponent.tsx')
      }
    },
    module: {
