  ...
  const ourConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        __PLAYROOM_ALIAS__ASSISTANT_CLIENT__: playroomConfig.assistantClient
          ? relativeResolve(playroomConfig.assistantClient)
          : require.resolve('./defaultModules/assistantClient.ts'),
      },
    },
    module: {
      rules: [
