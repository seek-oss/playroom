...
module.exports = async (playroomConfig, options) => {
  ...
  // before componentHints gets stringified, if its a function, run it to
  if (playroomConfig.componentHints instanceof Function) {
    playroomConfig.componentHints = playroomConfig.componentHints();
  }
