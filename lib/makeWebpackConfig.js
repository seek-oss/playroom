  ...
  const ourConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        __PLAYROOM_ALIAS__FRAME_ENTRY__: playroomConfig.frameEntry
          ? relativeResolve(playroomConfig.frameEntry)
          : require.resolve('./defaultModules/frameEntry'),
        __PLAYROOM_ALIAS__PLAYROOM_ENTRY__: playroomConfig.playroomEntry
          ? relativeResolve(playroomConfig.playroomEntry)
          : require.resolve('./defaultModules/playroomEntry'),
